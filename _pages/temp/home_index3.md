...
/* ── CENTRED INNER — 3/5 width, 1/5 margin each side ── */
.ck-inner {
  width: 60%;
  margin: 0 auto;
  max-width: 1100px;
}
@media (max-width: 1100px) { .ck-inner { width: 76%; } }
@media (max-width: 860px)  { .ck-inner { width: 88%; } }
@media (max-width: 600px)  { .ck-inner { width: 94%; } }
...
<script>
  ...
  function ckToggle() {
    ...
    // push bg to body so nothing bleeds white outside the wrapper
    document.body.style.background = isDark ? '#f9f7f3' : '#141210';
  }
